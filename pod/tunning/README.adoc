...
Link Priority class with namespace

So the idea i have. as we normally suggest to have T-Shirt size quotas and also Priority classes i want to link both togther to have a T-shirt sized projects. 
